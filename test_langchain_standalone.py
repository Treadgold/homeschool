#!/usr/bin/env python3
"""
Standalone test script for the LangChain agent service.
This completely bypasses the main app structure to avoid circular imports.
"""
...
async def test_standalone_langchain():
    """Test the LangChain agent directly without any app dependencies."""
    
    print("🧪 Testing LangChain Agent (Standalone)...")
    print("=" * 50)
...
if __name__ == "__main__":
    asyncio.run(test_standalone_langchain()) 